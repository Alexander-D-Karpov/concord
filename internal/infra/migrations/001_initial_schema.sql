...
CREATE INDEX idx_voice_servers_region_status ON voice_servers(region, status);
CREATE INDEX idx_voice_servers_owner ON voice_servers(owner_user_id);
...
CREATE INDEX idx_rooms_voice_server ON rooms(voice_server_id);
...
CREATE INDEX idx_memberships_room_role ON memberships(room_id, role);
